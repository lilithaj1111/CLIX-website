...
export default async function IndustryPage({
  ...
  const blueLime = "linear-gradient(135deg, #3B7BF5, #A3E635)";
            ...
            <div className="lg:col-span-5">
              <div className="rounded-[1.8rem] p-[1.5px] shadow-[0_40px_80px_-30px_rgba(11,19,38,0.3)]" style={{ background: blueLime }}>
                <div className="relative overflow-hidden rounded-[calc(1.8rem-1.5px)] bg-paper/80 p-8 backdrop-blur-md md:p-10">
                  <span aria-hidden className="absolute -right-16 -top-16 block h-44 w-44 rounded-full opacity-60 blur-3xl" style={{ background: "#A3E635" }} />
                  <span aria-hidden className="absolute -bottom-16 -left-16 block h-44 w-44 rounded-full opacity-60 blur-3xl" style={{ background: "#3B7BF5" }} />
