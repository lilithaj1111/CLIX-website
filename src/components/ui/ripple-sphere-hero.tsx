    ...
    <section
      ...
      style={{
        background: [
          ...
          "radial-gradient(78% 98% at 4% 26%, color-mix(in srgb, #BEF264 32%, transparent), transparent 58%)",
          "radial-gradient(46% 60% at 22% 70%, color-mix(in srgb, #A3E635 18%, transparent), transparent 64%)",
          // lime wash, right side
          "radial-gradient(60% 82% at 98% 34%, color-mix(in srgb, #BEF264 28%, transparent), transparent 60%)",
          "radial-gradient(44% 58% at 86% 80%, color-mix(in srgb, #A3E635 16%, transparent), transparent 64%)",
          // soft cool tint, bottom-centre
          "radial-gradient(60% 70% at 50% 96%, color-mix(in srgb, #C9E2F3 60%, transparent), transparent 64%)",
          // baby-blue base
          "linear-gradient(180deg, #EEF5FB 0%, #E6F0F7 52%, #DAE9F1 100%)",
        ].join(", "),
      }}
    >
      ...
      <div
        ...
        style={{
          background: [
            "radial-gradient(54% 100% at 50% 100%, color-mix(in srgb, #7FA9F7 40%, transparent), transparent 72%)",
            "radial-gradient(40% 90% at 30% 100%, color-mix(in srgb, #A3E635 26%, transparent), transparent 74%)",
            "radial-gradient(34% 80% at 72% 100%, color-mix(in srgb, #BEF264 20%, transparent), transparent 74%)",
          ].join(", "),
          filter: "blur(22px)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(120% 70% at 50% 22%, color-mix(in srgb, #F7FAFE 70%, transparent), transparent 58%)",
        }}
      />
